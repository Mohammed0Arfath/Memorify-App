    ...
    <>
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-gray-800 dark:text-slate-100 mb-2">AI Companion</h2>
                <p className="text-gray-600 dark:text-slate-300">
                  Your reflective writing partner
                  {!apiKeyMissing && !quotaExceeded && (
                    <span className="ml-2 text-sm text-green-600 dark:text-green-400">• Together.ai Enhanced</span>
                  )}
                  {quotaExceeded && (
                    <span className="ml-2 text-sm text-red-600 dark:text-red-400">• Fallback Mode</span>
                  )}
                </p>
              </div>
            </div>
        ...
        <div className="mb-6">
          {/* Error Message */}
          {error && (
            <div className="alert alert-error mb-4 fade-in bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-700/50 text-red-800 dark:text-red-300">
          ...
          {/* API Key Warning */}
          {apiKeyMissing && (
            <div className="alert alert-warning mb-4 fade-in bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-700/50 text-amber-800 dark:text-amber-300">
              <AlertCircle className="w-5 h-5 flex-shrink-0" />
          ...
          {/* Photo Preview */}
          {selectedPhoto && (
            <div className="alert alert-info mb-4 fade-in bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-700/50 text-blue-800 dark:text-blue-300">
        ...
        <div className="bg-white dark:bg-slate-800/50 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-slate-700 backdrop-blur-sm">
          ...
          {/* Input Area */}
          <div className="bg-gray-50 dark:bg-slate-700/50 border-t border-gray-200 dark:border-slate-700 p-6">
