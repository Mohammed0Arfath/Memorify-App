...
export const LandingPage: React.FC<LandingPageProps> = ({ onNavigateToAuth }) => {
  ...
  return (
    <div className="min-h-screen transition-colors duration-500 overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div className={`transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            {/* Enhanced Stats */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 max-w-2xl mx-auto px-4">
      ...
      <section id="features" className="relative py-16 sm:py-24 bg-white dark:bg-slate-800/50 transition-colors duration-500 overflow-hidden">
      ...
      <section className="relative py-16 sm:py-24 bg-gray-50 dark:bg-slate-900/50 transition-colors duration-500 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16 sm:mb-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-slate-100 mb-6">
              Loved by Thousands
      ...
      <section className="relative py-16 sm:py-24 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 dark:from-purple-700 dark:via-pink-700 dark:to-blue-700 overflow-hidden">
