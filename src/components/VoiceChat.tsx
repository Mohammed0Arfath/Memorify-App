...
export const VoiceChat: React.FC<VoiceChatProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 backdrop-animate">
      <div className="bg-white dark:bg-slate-800/95 backdrop-blur-sm rounded-xl shadow-2xl w-full max-w-md h-[400px] flex flex-col overflow-hidden fade-in-up border border-gray-200 dark:border-slate-700">
        {/* Compact Header */}
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 dark:from-purple-600 dark:to-pink-600 p-4 text-white">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white/20 dark:bg-white/30 rounded-full flex items-center justify-center hover-scale transition-smooth">
                <Mic className="w-4 h-4" />
              </div>
              <div>
                <h3 className="text-lg font-semibold">Voice Companion</h3>
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-1.5 bg-white/20 dark:bg-white/30 rounded-lg hover:bg-white/30 dark:hover:bg-white/40 transition-smooth hover-scale btn-press"
          ...
          {isLoading && (
            <div className="absolute inset-0 flex items-center justify-center bg-white dark:bg-slate-800 fade-in z-10">
              <div className="text-center">
                ...
                <p className="text-gray-600 dark:text-slate-300 text-sm">Initializing voice chat...</p>
              </div>
            </div>
          )}
